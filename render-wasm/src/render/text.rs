...
fn draw_text(
    ...
    for paragraph_builder_group in paragraph_builder_groups {
        ...
        for (paragraph_index, paragraph_builder) in paragraph_builder_group.iter_mut().enumerate() {
            ...
            println!("alphabetic_baseline {}", paragraph.alphabetic_baseline());
            println!("ideographic_baseline {}", paragraph.ideographic_baseline());
        ...
        println!("global_offset_y {}", global_offset_y);
